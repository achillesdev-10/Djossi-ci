...
export default function RegisterPage() {
  ...
  async function handleGoogleAuth() {
    ...
    try {
      ...
      document.cookie = `travaillerenci_role=${role}; path=/; max-age=86400`;
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-slate-950 flex flex-col items-center justify-center px-4 py-12 text-gray-900 dark:text-slate-50 transition-colors">
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 shadow-2xl">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-gray-500 dark:text-slate-400">Rejoignez la première plateforme d'emploi en Côte d'Ivoire</p>
        </div>
        ...
        <div className="space-y-3">
          <label className="block text-xs font-bold text-gray-700 dark:text-slate-400 uppercase tracking-widest">Je souhaite :</label>
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="text-[11px] text-gray-500 dark:text-slate-400 mt-0.5">Je cherche un emploi ou un stage</div>
            </button>
            ...
            >
              ...
              <div className="text-[11px] text-gray-500 dark:text-slate-400 mt-0.5">Je recrute des talents</div>
            </button>
          </div>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4 pt-2">
          {role === "candidate" ? (
            <div>
              <label className="block text-[10px] font-bold text-gray-600 dark:text-slate-400 uppercase tracking-widest mb-1.5 ml-1">Nom complet</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-[10px] font-bold text-gray-600 dark:text-slate-400 uppercase tracking-widest mb-1.5 ml-1">Nom de l'entreprise</label>
              <input
                type="text"
                required
          ...
          <div>
            <label className="block text-[10px] font-bold text-gray-600 dark:text-slate-400 uppercase tracking-widest mb-1.5 ml-1">Email professionnel ou personnel</label>
            <input
              type="email"
              required
