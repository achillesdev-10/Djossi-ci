      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-950 p-5 shadow-xl flex flex-col md:flex-row gap-4 items-center justify-between">
        <div className="w-full md:w-96 relative">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-slate-800 bg-slate-900 pl-11 pr-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-primary transition-colors"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
          <select
            ...
            className="rounded-2xl border border-slate-800 bg-slate-900 px-4 py-3 text-sm text-slate-200 focus:outline-none focus:border-primary transition-colors"
          >
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-800 bg-slate-900/50 text-xs font-semibold text-slate-400 uppercase tracking-wider">
                ...
                <th className="py-4 px-6">Statut (Vérifié)</th>
                  ...
                  <tr key={job.id} className="hover:bg-slate-900/40 transition-colors">
                    ...
                    <td className="py-4 px-6 text-right space-x-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-xl bg-slate-800 text-slate-200 hover:bg-slate-700 text-xs font-semibold transition-colors"
                      >
                        Éditer
                      </button>
                      <button
                        ...
                        className="px-3 py-1.5 rounded-xl bg-rose-500/10 text-rose-400 hover:bg-rose-500/20 text-xs font-semibold transition-colors"
                      >
                        Supprimer
                      </button>
                    </td>
            ...
            <form onSubmit={handleSaveEdit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setEditForm({ ...editForm, contract_type: e.target.value as JobOfferSchema['contract_type'] })
                  }
                  className="w-full rounded-2xl border border-slate-800 bg-slate-950 px-4 py-3 text-sm text-white focus:outline-none focus:border-primary"
                >
                  <option value="CDI">CDI</option>
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="rounded-2xl bg-primary px-5 py-3 text-xs font-bold text-slate-950 hover:brightness-110 transition-all shadow-lg shadow-primary/20"
                >
