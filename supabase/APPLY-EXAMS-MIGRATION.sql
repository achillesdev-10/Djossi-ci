-- ============================================================================
--  TravaillerEnCi — Migration Supabase « Module Concours » (table `exams`)
--  Fichier : supabase/APPLY-EXAMS-MIGRATION.sql
--
--  RENDU AUTONOME pour être appliqué tel quel :
--    • prérequis `trigger_set_timestamp()` (défini à l'origine dans la
--      migration 0001) — idempotent, ne casse rien s'il existe déjà ;
--    • intégralité de la migration 0010 (table `exams`, index, trigger,
--      RLS, RPC `increment_exam_views`).
--
--  À APPLIQUER (une seule fois, ré-exécutable sans risque) :
...
--       avec le corps : {"query": "<contenu de ce fichier>"}
--
--  Le script de resynchronisation correspondant :
--     npx tsx scripts/sync-exams-to-supabase.ts [--dry]
-- ============================================================================

-- ----------------------------------------------------------------------------
--  Prérequis : fonction de timestamp auto (migration 0001)
-- ----------------------------------------------------------------------------
...
-- ============================================================================
--  Migration 0010 — table dédiée `exams` — Module Concours Administratifs
-- ============================================================================
